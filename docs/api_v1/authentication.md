...
每个账号（以及企业版套餐中的子账号），都可以在「个人中心」中，[获取自己账号的 API Key 和 API Secret](https://jinshuju.net/profile/api) 。
...
__个人级别的 API，只可以访问对应账号创建的表单，以及相应的数据__
...
2. 「系统设置」
3. [「企业 API」](https://jinshuju.net/system/api_licence)
4. 如果是第一次访问，点击 「开启 API 访问」
